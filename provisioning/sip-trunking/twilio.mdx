...
description: "Guia passo a passo para conectar sua conta Twilio à OmniTech via SIP trunking, incluindo credenciais, configuração de rotas e validação da chamada."
---
