...
description: "Lista todos os assistentes de IA do usuário autenticado, com suporte a paginação e filtros para inbound, outbound e diferentes status de configuração."
---
