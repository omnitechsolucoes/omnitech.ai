...
description: "Desativa as notificações de webhook para chamadas inbound de um assistente específico, interrompendo o envio de eventos pós-chamada de entrada."
---
