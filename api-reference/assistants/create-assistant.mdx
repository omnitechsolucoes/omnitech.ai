...
description: "Cria um novo assistente de IA na OmniTech com voz, modelo LLM, prompt, ferramentas e demais configurações via uma requisição POST autenticada."
---
