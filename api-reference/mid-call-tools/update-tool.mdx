...
description: "Atualiza uma ferramenta de uso durante a chamada existente, alterando nome, descrição, parâmetros ou endpoint sem precisar recriar a integração."
---
