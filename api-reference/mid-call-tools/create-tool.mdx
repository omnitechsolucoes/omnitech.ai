...
api: "POST /user/tools"
description: "Cria uma nova ferramenta personalizada de uso durante a chamada, definindo nome, descrição, parâmetros e endpoint que será chamado pelo assistente."
---
