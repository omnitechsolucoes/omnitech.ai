...
description: "Lista todas as campanhas de chamadas outbound da conta OmniTech, com status, métricas de progresso e identificadores para gerenciamento via API."
---
