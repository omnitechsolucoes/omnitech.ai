...
icon: "webhook"
description: "Estrutura do webhook pós-chamada da OmniTech: variáveis extraídas, transcrição, gravação, status e metadados enviados ao concluir cada chamada."
---
